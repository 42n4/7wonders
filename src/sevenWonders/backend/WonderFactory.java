...
public class WonderFactory {
    ...
    private static class GoldAndVictory extends GoldWonder implements VictoryPoints {
	int points;
    ...
    private static class ArmyGoldANdVictory extends GoldAndVictory implements Shields {
    ...
    private static Wonder[] allWonders = new Wonder[] {
	    ...
	    new WonderBuilder("wonder - 1.png", Resource.ORE)
	    	.addCost(Resource.WOOD, 2).finishStage(new VictoryWonder(3))
	    ...
	    new WonderBuilder("wonder - 2.png", Resource.PAPYRUS)
	    	.addCost(Resource.STONE, 2).finishStage(new VictoryWonder(3))
	    	.addCost(Resource.WOOD, 2).finishStage(new GoldWonder(9))
	    	.addCost(Resource.PAPYRUS, 2).finishStage(new VictoryWonder(7))
	    .done(),
	    // Gizah A
	    new WonderBuilder("wonder - 3.png", Resource.STONE)
	    	.addCost(Resource.STONE, 2).finishStage(new VictoryWonder(3))
	    	.addCost(Resource.WOOD, 3).finishStage(new VictoryWonder(5))
	    	.addCost(Resource.STONE, 4).finishStage(new VictoryWonder(7))
	    .done(),
	    // Alexandria A
	    new WonderBuilder("wonder - 4.png", Resource.GLASS)
	    	.addCost(Resource.STONE, 2).finishStage(new VictoryWonder(3))
	    	.addCost(Resource.ORE, 2).finishStage(new ResourceWonder(false))
	    	.addCost(Resource.GLASS, 2).finishStage(new VictoryWonder(7))
	    .done(),
	    // Rhódos B
	    new WonderBuilder("wonder - 5.png", Resource.ORE)
	    	.addCost(Resource.STONE, 3).finishStage(new ArmyGoldANdVictory(3, 3))
	    	.addCost(Resource.ORE, 4).finishStage(new ArmyGoldANdVictory(4, 4))
	    .done(),
	    // Gizah B
	    new WonderBuilder("wonder - 6.png", Resource.STONE)
	    	.addCost(Resource.WOOD, 2).finishStage(new VictoryWonder(3))
	    	.addCost(Resource.STONE, 3).finishStage(new VictoryWonder(5))
	    	.addCost(Resource.CLAY, 3).finishStage(new VictoryWonder(5))
	    	.addCost(Resource.PAPYRUS, 1).addCost(Resource.STONE, 4).finishStage(new VictoryWonder(7))
	    .done(),
    };
}
